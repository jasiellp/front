(function ($, DataTable) {
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: function (dt) {
            return '<i class="fa fa-undo"></i> ' + dt.i18n('buttons.reset', 'Resetar');
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: function (dt) {
            return '<i class="fa fa-refresh"></i> ' + dt.i18n('buttons.reload', 'Atualizar');
        },
    ...
    DataTable.ext.buttons.create = {
        ...
        text: function (dt) {
            return '<i class="fa fa-plus"></i> ' + dt.i18n('buttons.create', 'Criar');
        },
